...
import {b2_epsilon, b2_maxFloat, b2_maxSubSteps, b2_maxTOIContacts} from '../common/b2_settings.js';
import {b2Min, b2Sweep, b2Transform, b2Vec2, XY} from '../common/b2_math.js';
...
import {b2IJointDef, b2Joint, b2JointEdge, b2JointType} from './b2_joint.js';
...
import {b2IMotorJointDef, b2MotorJoint} from './b2_motor_joint.js';
import {b2IMouseJointDef, b2MouseJoint} from './b2_mouse_joint.js';
import {b2IPrismaticJointDef, b2PrismaticJoint} from './b2_prismatic_joint.js';
import {b2IPulleyJointDef, b2PulleyJoint} from './b2_pulley_joint.js';
import {b2IRevoluteJointDef, b2RevoluteJoint} from './b2_revolute_joint.js';
import {b2IWeldJointDef, b2WeldJoint} from './b2_weld_joint.js';
import {b2IWheelJointDef, b2WheelJoint} from './b2_wheel_joint.js';
import {b2Body, b2BodyType, b2IBodyDef} from './b2_body.js';
...
} from './b2_world_callbacks.js';
import {b2CalculateParticleIterations} from '../particle/b2_particle.js';
import {b2ParticleSystem, b2ParticleSystemDef} from '../particle/b2_particle_system.js';
// #endif
...
export class b2World {
    ...
    public Step(dt: number, velocityIterations: number, positionIterations: number, particleIterations: number = this.CalculateReasonableParticleIterations(dt)): void {
        ...
        this.m_callbacks.forEach(cb => cb());
        this.m_callbacks = [];

        this.m_profile.step = stepTimer.GetMilliseconds();
    }

    m_callbacks: Array<() => void> = [];
